...
namespace HotelGarage.Helpers
{
    public static class Constants
    {
        ...
        public const string DepartureStateOfPlaceConstant = "Odjezd";
        public const string FreeStateOfPlaceConstant = "Volno";
        public const string FreeStaffStateOfPlaceConstant = "Volno Staff";
